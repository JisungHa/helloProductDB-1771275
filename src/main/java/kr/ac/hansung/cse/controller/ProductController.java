...
public class ProductController {
	...
	@GetMapping("/products")
	public ResponseEntity<List<Product>> getAllProductTables() {
	...
	public ResponseEntity<Product> getProductById(@PathVariable("id") long id) {
		Optional<Product> productTableData = repository.findById(id);

		if (productTableData.isPresent()) {
			return new ResponseEntity<>(productTableData.get(), HttpStatus.OK);
		} else {
